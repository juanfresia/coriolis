...
class TestCInstrumenter(unittest.TestCase):
    def test_can_instrument(self):
        l = LanguageCInstrumenter('/vagrant/resources/prod_cons.chk')
...
class TestCPPInstrumenter(unittest.TestCase):
    def test_can_instrument(self):
        l = LanguageCppInstrumenter('/vagrant/resources/prod_cons.chk')
        self.assertTrue(l.can_instrument("test.cpp"))
        self.assertTrue(l.can_instrument("test.h"))
        self.assertFalse(l.can_instrument("test.py"))

    def test_normal_line(self):
        l = LanguageCppInstrumenter('/vagrant/resources/prod_cons.chk').instrument_line('printf("Hello world");')
        self.assertEqual(l, 'printf("Hello world");')

    def test_checkpoint_line(self):
        l = LanguageCppInstrumenter('/vagrant/resources/prod_cons.chk').instrument_line('// @checkpoint produce 1 2')
        self.assertEqual(l, 'coriolis_logger_write("%s  %d  %d", (char*) "produce", 1, 2);\n')

    def test_checkpoint_not_in_table(self):
        l = LanguageCppInstrumenter('/vagrant/resources/prod_cons.chk').instrument_line('// @checkpoint magic 8')
        self.assertEqual(l, '// @checkpoint magic 8')
...
class TestPyInstrumenter(unittest.TestCase):
    def test_can_instrument(self):
        l = LanguagePyInstrumenter('/vagrant/resources/prod_cons.chk')
        self.assertTrue(l.can_instrument("test.py"))
        self.assertFalse(l.can_instrument("test.c"))

    def test_normal_line(self):
        l = LanguagePyInstrumenter('/vagrant/resources/prod_cons.chk').instrument_line('print("Hello world")')
    ...
    def test_checkpoint_not_in_table(self):
        l = LanguagePyInstrumenter('/vagrant/resources/prod_cons.chk').instrument_line('# @checkpoint magic 8')
        self.assertEqual(l, '# @checkpoint magic 8')
