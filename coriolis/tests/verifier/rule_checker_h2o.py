...
class TestHighLoadH2O(unittest.TestCase):
    ...
    rule_6_statement = (
        ...
        "rule molecules_made_500\n"
        "water_made() must happen 500 times\n"
    )
    rule_6_header = "molecules_made_500"
    rule_6_fact = RuleFact([
        MatchCheckpoints(["water_made"]),
        CrossAndGroupByArgs([["water_made"]]),
